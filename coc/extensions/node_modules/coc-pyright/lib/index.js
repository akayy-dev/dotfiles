...
var require_yallist = __commonJS((exports, module2) => {
  "use strict";
...
var require_lru_cache = __commonJS((exports, module2) => {
  "use strict";
  ...
  function patch(fs7) {
    ...
    function patchLchmod(fs8) {
      fs8.lchmod = function(path11, mode, callback) {
        fs8.open(path11, constants.O_WRONLY | constants.O_SYMLINK, mode, function(err, fd) {
          if (err) {
            if (callback)
              callback(err);
            return;
...
var require_graceful_fs = __commonJS((exports, module2) => {
  ...
  function patch(fs8) {
    ...
    function go$readdir(args) {
      return fs$readdir.apply(fs8, args);
    }
...
var require_at_least_node = __commonJS((exports, module2) => {
  module2.exports = (r) => {
...
var require_make_dir = __commonJS((exports, module2) => {
  "use strict";
  var fs7 = require_fs();
  ...
  var processOptions = (options) => {
    ...
    return __objSpread(__objSpread({}, defaults), options);
  };
  ...
  module2.exports.makeDir = async (input, options) => {
    ...
    const make = async (pth) => {
      try {
        await fs7.mkdir(pth, options.mode);
      } catch (error) {
        if (error.code === "EPERM") {
          throw error;
        }
        ...
        try {
          const stats = await fs7.stat(pth);
  ...
  module2.exports.makeDirSync = (input, options) => {
    ...
    const make = (pth) => {
      try {
        fs7.mkdirSync(pth, options.mode);
      } catch (error) {
        if (error.code === "EPERM") {
          throw error;
        }
        ...
        try {
          if (!fs7.statSync(pth).isDirectory()) {
            throw new Error("The path is not a directory");
          }
        } catch {
          throw error;
...
var require_mkdirs = __commonJS((exports, module2) => {
  "use strict";
...
var require_utimes = __commonJS((exports, module2) => {
  "use strict";
  var fs7 = require_graceful_fs();
  function utimesMillis(path11, atime, mtime, callback) {
    fs7.open(path11, "r+", (err, fd) => {
      if (err)
        return callback(err);
...
var require_stat = __commonJS((exports, module2) => {
  "use strict";
  var fs7 = require_fs();
  var path11 = require("path");
  var util = require("util");
  ...
  var stat = (file) => nodeSupportsBigInt ? fs7.stat(file, {bigint: true}) : fs7.stat(file);
  var statSync = (file) => nodeSupportsBigInt ? fs7.statSync(file, {bigint: true}) : fs7.statSync(file);
  ...
  function checkParentPaths(src, srcStat, dest, funcName, cb) {
    ...
    if (nodeSupportsBigInt)
      fs7.stat(destParent, {bigint: true}, callback);
    else
      fs7.stat(destParent, callback);
  }
...
var require_copy_sync = __commonJS((exports, module2) => {
  "use strict";
  var fs7 = require_graceful_fs();
  var path11 = require("path");
...
var require_copy_sync2 = __commonJS((exports, module2) => {
  "use strict";
  module2.exports = {
...
var require_path_exists = __commonJS((exports, module2) => {
  "use strict";
  var u = require_universalify().fromPromise;
  var fs7 = require_fs();
  function pathExists(path11) {
    return fs7.access(path11).then(() => true).catch(() => false);
  }
  module2.exports = {
...
var require_copy = __commonJS((exports, module2) => {
  "use strict";
  var fs7 = require_graceful_fs();
  var path11 = require("path");
...
var require_copy2 = __commonJS((exports, module2) => {
  "use strict";
  var u = require_universalify().fromCallback;
  module2.exports = {
    copy: u(require_copy())
...
var require_rimraf = __commonJS((exports, module2) => {
  "use strict";
  var fs7 = require_graceful_fs();
  var path11 = require("path");
...
var require_empty = __commonJS((exports, module2) => {
  "use strict";
  var u = require_universalify().fromCallback;
  var fs7 = require_graceful_fs();
  var path11 = require("path");
...
var require_link = __commonJS((exports, module2) => {
  "use strict";
  var u = require_universalify().fromCallback;
  var path11 = require("path");
  var fs7 = require_graceful_fs();
  ...
  function createLinkSync(srcpath, dstpath) {
    const destinationExists = fs7.existsSync(dstpath);
    if (destinationExists)
      return void 0;
    try {
      fs7.lstatSync(srcpath);
    } catch (err) {
...
var require_symlink_paths = __commonJS((exports, module2) => {
  "use strict";
  var path11 = require("path");
  var fs7 = require_graceful_fs();
  var pathExists = require_path_exists().pathExists;
...
var require_symlink_type = __commonJS((exports, module2) => {
  "use strict";
  var fs7 = require_graceful_fs();
...
var require_symlink = __commonJS((exports, module2) => {
  "use strict";
  var u = require_universalify().fromCallback;
  var path11 = require("path");
  var fs7 = require_graceful_fs();
...
var require_ensure = __commonJS((exports, module2) => {
  "use strict";
...
var require_universalify2 = __commonJS((exports) => {
  "use strict";
  exports.fromCallback = function(fn) {
    return Object.defineProperty(function(...args) {
      if (typeof args[args.length - 1] === "function")
...
var require_jsonfile = __commonJS((exports, module2) => {
  var _fs;
  try {
...
var require_jsonfile2 = __commonJS((exports, module2) => {
  "use strict";
...
var require_output_json = __commonJS((exports, module2) => {
  "use strict";
...
var require_output_json_sync = __commonJS((exports, module2) => {
  "use strict";
  var {stringify} = require_utils();
...
var require_move_sync = __commonJS((exports, module2) => {
  "use strict";
  var fs7 = require_graceful_fs();
  var path11 = require("path");
...
var require_move_sync2 = __commonJS((exports, module2) => {
  "use strict";
  module2.exports = {
...
var require_move = __commonJS((exports, module2) => {
  "use strict";
  var fs7 = require_graceful_fs();
  var path11 = require("path");
...
var require_move2 = __commonJS((exports, module2) => {
  "use strict";
  var u = require_universalify().fromCallback;
  module2.exports = {
    move: u(require_move())
...
var require_lib = __commonJS((exports, module2) => {
  "use strict";
  module2.exports = __objSpread(__objSpread(__objSpread(__objSpread(__objSpread(__objSpread(__objSpread(__objSpread(__objSpread(__objSpread(__objSpread(__objSpread({}, require_fs()), require_copy_sync2()), require_copy2()), require_empty()), require_ensure()), require_json()), require_mkdirs()), require_move_sync2()), require_move2()), require_output()), require_path_exists()), require_remove());
  var fs7 = require("fs");
  if (Object.getOwnPropertyDescriptor(fs7, "promises")) {
...
var require_untildify = __commonJS((exports, module2) => {
  "use strict";
  var os2 = require("os");
...
var require_crypt = __commonJS((exports, module2) => {
  (function() {
...
var require_charenc = __commonJS((exports, module2) => {
  var charenc = {
    utf8: {
...
var require_is_buffer = __commonJS((exports, module2) => {
  /*!
...
var require_md5 = __commonJS((exports, module2) => {
  (function() {
...
var require_diff_match_patch = __commonJS((exports, module2) => {
...
var require_safer = __commonJS((exports, module2) => {
  "use strict";
...
var require_internal = __commonJS((exports, module2) => {
  "use strict";
...
var require_sbcs_data = __commonJS((exports, module2) => {
  "use strict";
  module2.exports = {
    "10029": "maccenteuro",
    maccenteuro: {
...
var require_sbcs_data_generated = __commonJS((exports, module2) => {
  "use strict";
  module2.exports = {
    "437": "cp437",
    "737": "cp737",
...
var require_shiftjis = __commonJS((exports, module2) => {
  module2.exports = [
    ["0", "\0", 128],
    ["a1", "\uFF61", 62],
...
var require_eucjp = __commonJS((exports, module2) => {
  module2.exports = [
    ["0", "\0", 127],
    ["8ea1", "\uFF61", 62],
...
var require_cp936 = __commonJS((exports, module2) => {
  module2.exports = [
    ["0", "\0", 127, "\u20AC"],
...
var require_gbk_added = __commonJS((exports, module2) => {
  module2.exports = [
    ["a140", "\uE4C6", 62],
    ["a180", "\uE505", 32],
    ["a240", "\uE526", 62],
...
var require_gb18030_ranges = __commonJS((exports, module2) => {
...
var require_cp949 = __commonJS((exports, module2) => {
  module2.exports = [
    ["0", "\0", 127],
...
var require_cp950 = __commonJS((exports, module2) => {
  module2.exports = [
    ["0", "\0", 127],
    ["a140", "\u3000\uFF0C\u3001\u3002\uFF0E\u2027\uFF1B\uFF1A\uFF1F\uFF01\uFE30\u2026\u2025\uFE50\uFE51\uFE52\xB7\uFE54\uFE55\uFE56\uFE57\uFF5C\u2013\uFE31\u2014\uFE33\u2574\uFE34\uFE4F\uFF08\uFF09\uFE35\uFE36\uFF5B\uFF5D\uFE37\uFE38\u3014\u3015\uFE39\uFE3A\u3010\u3011\uFE3B\uFE3C\u300A\u300B\uFE3D\uFE3E\u3008\u3009\uFE3F\uFE40\u300C\u300D\uFE41\uFE42\u300E\u300F\uFE43\uFE44\uFE59\uFE5A"],
...
var require_big5_added = __commonJS((exports, module2) => {
  module2.exports = [
...
var require_dbcs_data = __commonJS((exports, module2) => {
  "use strict";
  module2.exports = {
    shiftjis: {
      type: "_dbcs",
...
var require_encodings = __commonJS((exports, module2) => {
  "use strict";
  var modules = [
    require_internal(),
    require_utf32(),
...
var require_streams = __commonJS((exports, module2) => {
  "use strict";
  var Buffer2 = require_safer().Buffer;
...
var require_tree_kill = __commonJS((exports, module2) => {
  "use strict";
...
var require_named_js_regexp = __commonJS((exports, module2) => {
  "use strict";
  (function(window10) {
...
var PythonCodeActionProvider = class {
  ...
  provideCodeActions(document, range) {
    ...
    const actions = [];
    const config2 = import_coc.workspace.getConfiguration("pyright");
    const provider = config2.get("organizeimports.provider", "pyright");
    if (provider === "pyright") {
      actions.push({
...
var _PythonSettings = class {
  ...
  static dispose() {
    _PythonSettings.pythonSettings.forEach((item) => item && item.dispose());
    ...
    try {
      ...
      if (import_fs_extra.default.existsSync(p)) {
        if (!process.env.PYENV_VERSION) {
          process.env.PYENV_VERSION = import_fs_extra.default.readFileSync(p).toString().trim().split("\n")[0];
        }
        return;
      }
  ...
  getAbsolutePath(pathToCheck, rootDir) {
    ...
    pathToCheck = (0, import_untildify.default)(pathToCheck);
...
var isArray2 = /* @__PURE__ */ function() {
...
var ProcessService = class {
  ...
  execObservable(file, args, options = {}) {
    ...
    const proc = (0, import_child_process.spawn)(file, args, spawnOptions);
  ...
  exec(file, args, options = {}) {
    if (file.startsWith("~/")) {
      file = file.replace("~", (0, import_os2.homedir)());
    }
    const spawnOptions = this.getDefaultOptions(options);
  ...
  getDefaultOptions(options) {
    const defaultOptions = __objSpread({}, options);
    ...
    if (!defaultOptions.env || Object.keys(defaultOptions.env).length === 0) {
      defaultOptions.env = __objSpread({}, process.env);
    } else {
      defaultOptions.env = __objSpread({}, defaultOptions.env);
    }
...
function getTempFileWithDocumentContents(document) {
  return new Promise((resolve, reject) => {
    ...
    const fileName = `${fsPath}.${(0, import_md5.default)(document.uri)}${ext}`;
...
var BaseFormatter = class {
  ...
  deleteTempFile(originalFile, tempFile) {
    if (originalFile !== tempFile) {
      return (0, import_util.promisify)(import_fs_extra2.default.unlink)(tempFile);
    }
...
function getTempFileWithDocumentContents2(document) {
  return new Promise((resolve, reject) => {
    ...
    const fileName = `${fsPath}.${(0, import_md52.default)(document.uri)}${path3.extname(fsPath)}`;
    import_fs_extra3.default.writeFile(fileName, document.getText(), (ex) => {
      if (ex) {
        reject(new Error(`Failed to create a temporary file, ${ex.message}`));
      }
      resolve(fileName);
...
async function generateIsortFixDiff(extensionRoot, document) {
  const pythonSettings = PythonSettings.getInstance();
  const {path: isortPath, args: userArgs} = pythonSettings.sortImports;
  const args = ["--diff"].concat(userArgs);
  const tempFile = await getTempFileWithDocumentContents2(document);
  args.push(tempFile);
  const pythonToolsExecutionService = new PythonExecutionService();
  let executionInfo;
  ...
  await import_fs_extra3.default.unlink(tempFile);
...
var Prospector = class extends BaseLinter {
  ...
  async runLinter(document, cancellation) {
    const relativePath = import_path3.default.relative(import_coc14.workspace.root, import_coc14.Uri.parse(document.uri).fsPath);
...
var PyCodeStyle = class extends BaseLinter {
  ...
  async runLinter(document, cancellation) {
    const messages = await this.run(["--format=%(row)d,%(col)d,%(code).1s,%(code)s:%(text)s", import_coc15.Uri.parse(document.uri).fsPath], document, cancellation);
    messages.forEach((msg) => {
...
var Pylint = class extends BaseLinter {
  ...
  async hasConfigurationFile(folder) {
    ...
    if (await import_fs_extra4.default.pathExists(path7.join(folder, pylintrc)) || await import_fs_extra4.default.pathExists(path7.join(folder, dotPylintrc))) {
      return true;
    }
    let current = folder;
    let above = path7.dirname(folder);
    do {
      if (!await import_fs_extra4.default.pathExists(path7.join(current, "__init__.py"))) {
        break;
      }
      if (await import_fs_extra4.default.pathExists(path7.join(current, pylintrc)) || await import_fs_extra4.default.pathExists(path7.join(current, dotPylintrc))) {
        return true;
      }
      current = above;
    ...
    if (await import_fs_extra4.default.pathExists(path7.join(home, dotPylintrc))) {
      return true;
    }
    if (await import_fs_extra4.default.pathExists(path7.join(home, ".config", pylintrc))) {
      return true;
    }
    if (!this.isWindows) {
      if (await import_fs_extra4.default.pathExists(path7.join("/etc", pylintrc))) {
        return true;
      }
    }
    return false;
...
var Pytype = class extends BaseLinter {
  ...
  async hasConfigurationFile(folder) {
    if (await import_fs_extra5.default.pathExists(path8.join(folder, pytypecfg))) {
      return true;
    }
    let current = folder;
    let above = path8.dirname(folder);
    do {
      if (!await import_fs_extra5.default.pathExists(path8.join(current, "__init__.py"))) {
        break;
      }
      if (await import_fs_extra5.default.pathExists(path8.join(current, pytypecfg))) {
        return true;
      }
      current = above;
...
`);
  ...
  shouldLintDocument(document) {
    ...
    const exists = import_fs_extra6.default.existsSync(u.fsPath);
    if (!exists) {
...
async function activate(context) {
  ...
  const disableDiagnostics = pyrightCfg.get("disableDiagnostics");
...
`);
  ...
  genericCommands.forEach((command) => {
    context.subscriptions.push(import_coc24.commands.registerCommand(command, async (...args) => {
      ...
      const doc = await import_coc24.workspace.document;
      const filePath = import_coc24.Uri.parse(doc.uri).fsPath;
      if (args[args.length - 1] !== filePath) {
        args.unshift(import_coc24.workspace.root);
        args.push(filePath);
      }
      const cmd = {
        command,
  ...
  context.subscriptions.push(disposable);
  disposable = import_coc24.commands.registerCommand("pyright.version", () => {
    const pyrightJSON = (0, import_path5.join)(context.extensionPath, "node_modules", "pyright", "package.json");
  ...
  disposable = import_coc24.languages.registerCompletionItemProvider("python-import", "PY", "python", provider, [" "]);
  context.subscriptions.push(disposable);
}
var ImportCompletionProvider = class {
  async provideCompletionItems(document, position, token, context) {
    if (context.triggerCharacter !== " ")
      return [];
    const line = document.getText(import_coc24.Range.create(position.line, 0, position.line, position.character)).trim();
    ...
    const source = import_coc24.sources.sources.find((s) => s.name.includes("pyright"));
    if (!source)
      return [];
